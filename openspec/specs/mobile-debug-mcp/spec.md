...
Define the debug-only MCP sidecar and React Native bridge used to inspect, seed, navigate, and exercise mobile app state during local development without exposing production users or secrets.
