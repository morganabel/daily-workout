# account-transition Specification

## Purpose

Define supported anonymous-to-authenticated ownership transition across Better Auth, application-owned PostgreSQL state, mobile storage scopes, and server-owned RevenueCat identity.
