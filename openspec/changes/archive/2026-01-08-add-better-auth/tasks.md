...
- [x] 0.2 Add explicit "secrets never logged" constraints (server + mobile) and remove any request logging that could capture auth payloads
...
- [x] 1.7 Run initial migration against local PostgreSQL
...
- [x] 5.1 Add test: Authorization header is redacted in server logs
- [x] 5.2 Add test: Auth endpoint request bodies (email/password) are redacted in logs
- [x] 5.3 Add test: Error responses do not include secrets
...
- [x] 7.4 Test full auth flow on device/simulator
- [x] 7.5 Test backend switching (verify storagePrefix isolation)
