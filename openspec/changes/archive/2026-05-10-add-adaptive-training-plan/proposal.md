...
- Update plan/profile UI away from “starter week” editing and toward flexible training plan summaries with advanced mechanics hidden behind user-friendly labels.
...
- `mobile-ui`: Onboarding, Home, and Profile/Plan Settings must present flexible training plan summaries, coach recommendations, and adaptable weekly guidance instead of only starter-week slots.
