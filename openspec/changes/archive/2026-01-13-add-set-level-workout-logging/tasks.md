...
- [x] 1.1 Add shared contract schemas/types for set-level logs (set, exercise log, session detail, and a log payload) including `weightUnit: 'lb' | 'kg'` and integer `RPE`, in `@leveza/shared`.
