...
- Hosted quota enforcement must use generation G1's provider-selected credential attribution. Atomic generation-result and quota finalization in B4 depends on generation G5.
