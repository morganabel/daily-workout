...
const scenarios: GenerationEvaluationScenario[] = [
  ...
  createScenario({
    id: 'coach-slot-stable-squat-preserved',
    title: 'Coach program preserves stable barbell squat slot',
    description:
      'A coach strength program carries a stable primary squat slot and the required equipment is available, so the main lift should be preserved.',
    tags: ['coach-slot', 'slot-preservation', 'strength', 'barbell', 'initial'],
    mode: 'initial',
    request: {
      timeMinutes: 60,
      ...
      focus: 'Lower Body',
      adaptivePlanIntent: {
        planId: 'coach-plan-strength-performance',
        recommendationId: 'rec-lower-strength-stable',
        scheduleStrategy: 'fixed-calendar',
        ...
        repairRationale: [],
        primaryBlock: {
          blockId: 'lower-strength',
          label: 'Lower Body Strength',
          category: 'strength',
          role: 'primary-lower',
          stressTags: ['lower-body', 'strength'],
        },
        exerciseSlotPolicy: {
          slots: [
            {
              id: 'slot-primary-squat',
              label: 'Primary Squat',
    ...
    softReviewHints: [
      'The stable primary squat slot should be preserved as a barbell back squat',
      'No slot override reason should be recorded because the required equipment is available',
    ],
  }),
  createScenario({
    id: 'coach-slot-equipment-override-bodyweight',
    title: 'Coach squat slot overridden when only bodyweight is available',
    description:
      'A coach program carries a stable barbell squat slot, but today the user only has bodyweight, forcing an equipment-driven slot override.',
    tags: ['coach-slot', 'slot-override', 'equipment', 'bodyweight', 'initial'],
    mode: 'initial',
    request: {
      timeMinutes: 40,
      equipment: ['Bodyweight'],
      ...
      adaptivePlanIntent: {
        planId: 'coach-plan-strength-performance',
        recommendationId: 'rec-lower-strength-travel',
        scheduleStrategy: 'fixed-calendar',
        sessionDisposition: 'projected',
        projectionStatus: 'projected',
        addOnBlocks: [],
    ...
    context: buildContext({
      ...
      energyToday: 'moderate',
      primaryGoal: 'build strength',
      notes: 'Traveling today with no equipment available.',
      recentSessions: [],
    }),
    hardExpectations: {
      requiredFocus: 'Lower Body',
      bannedExerciseTerms: ['barbell'],
    },
    softReviewHints: [
      'The barbell squat slot cannot be honored with bodyweight only and must be overridden',
      'An equipment-unavailable override reason should be recorded for the squat slot',
    ],
  }),
  createScenario({
    id: 'coach-slot-injury-override-with-rotatable-accessory',
    title: 'Coach overhead-press slot overridden by shoulder injury',
    description:
      'A coach upper-body program carries a stable overhead press slot and a coach-rotatable accessory slot; a shoulder injury should override the press while the accessory may rotate.',
    tags: [
      'coach-slot',
      'slot-override',
      'injury',
    ...
    request: {
      ...
      focus: 'Upper Body',
      adaptivePlanIntent: {
        planId: 'coach-plan-hypertrophy-upper',
        recommendationId: 'rec-upper-injury',
        scheduleStrategy: 'fixed-calendar',
        sessionDisposition: 'projected',
        projectionStatus: 'projected',
        primaryBlock: {
          blockId: 'upper-strength',
        ...
        addOnBlocks: [
          {
            blockId: 'upper-accessory',
            label: 'Upper Accessory',
            category: 'accessory',
            role: 'accessory',
            stressTags: ['upper-body', 'accessory'],
          },
        ],
        targetRangeContext: [],
        rationale: [],
        ...
        exerciseSlotPolicy: {
          slots: [
            {
              id: 'slot-overhead-press',
              label: 'Overhead Press',
              sourceBlockId: 'upper-strength',
              role: 'primary-press',
              stabilityPolicy: 'stable',
              targetExerciseCount: 1,
              movementTags: ['vertical-press', 'overhead'],
              focusTags: ['shoulders', 'push'],
              preferredExerciseIds: [],
              eligibleExerciseIds: [],
              requiredEquipment: ['Dumbbells'],
            },
            {
              id: 'slot-arm-accessory',
              label: 'Arm Accessory',
              sourceBlockId: 'upper-accessory',
              role: 'accessory',
              stabilityPolicy: 'coach-rotatable',
              targetExerciseCount: 1,
              movementTags: ['elbow-flexion', 'arms'],
              focusTags: ['arms', 'accessory'],
              preferredExerciseIds: [],
              eligibleExerciseIds: [],
              requiredEquipment: ['Dumbbells'],
            },
          ...
          currentAssignments: [
            {
              slotId: 'slot-overhead-press',
              exerciseName: 'Dumbbell Overhead Press',
              source: 'coach',
              locked: false,
            },
            {
              slotId: 'slot-arm-accessory',
    ...
    softReviewHints: [
      'The stable overhead press slot must be overridden with an injury-conflict reason due to shoulder irritation',
      'The coach-rotatable arm accessory slot may vary but should remain a safe, pressing-free accessory',
    ],
  }),
];
